...
\\
   \wt{\bmc F}_{1\parallel}(z_2)
  -\wt{\bmc F}_{2\parallel}(z_2)
\\
   \wt{\bmc F}_{2\parallel}(z_3)
...
%====================================================================%
\numeq{fsm1fs}
 { \Big(\vb f_{s-1}\Big)_\ell = -\wt {\mc G_{\ell j}^{s}}_{\parallel}(z\subt{S}-z_{s-1}),
   \qquad
   \Big(\vb f_{s}\Big)_\ell   = +\wt {\mc G_{\ell j}^s}_{\parallel}(z\subt{S}-z_{s})
 }
%====================================================================%
...
\wt{\mc F_i}(z\subt{D})
&= \sum_{q=0}^1 (-1)^{p+q}
   \wt{\bmc G^d}_{i,\parallel} (z_{d-1+q}-z\subt{D})
   \vb W_{d-1+q,s-1+p}
   \wt{\bmc G^s}_{\parallel, j} (z\subt{S} - z_{s-1+p})
\end{align*}
%====================================================================%
