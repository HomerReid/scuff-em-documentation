...
\markright{Homer Reid: Full-wave substrate in {\sc scuff-em}}
...
\begin{itemize}
 ...
 \item For command-line calculations, you can add the option
       ...
       \begin{verbcode}
       --SubstrateFile MySubstrate.substrate \end{verbcode} to the {\sc scuff-static} command line.  The substrate file specified in this way will override any \texttt{SUBSTRATE} specification that may be present in the \texttt{.scuffgeo} file.  \end{itemize} %====================================================================% %====================================================================% %====================================================================% \newpage \section{Theory: How it works} \label{TheorySection} This discussion consists of two parts, mirroring the discussion of my previous memo for the electrostatic case.  \begin{itemize} \item I first derive a mathematical expression for the dyadic Green's functions
 ...
 these modified Green's functions.
\end{itemize}
